        ...
        >
            ...
            <div className="flex items-center gap-1.5 sm:gap-3">
                <div
                    ...
                    className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center font-black text-xs sm:text-base cursor-pointer transition-colors ${isDark ? 'bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/20' : 'bg-emerald-500/10 border border-emerald-500/40 text-emerald-600 hover:bg-emerald-500/20'
                        }`}
