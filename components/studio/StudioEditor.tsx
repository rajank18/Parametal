...
export const StudioEditor: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <nav
        className={`fixed bottom-0 left-0 right-0 md:hidden flex items-center justify-around h-14 border-t z-40 px-2 transition-colors ${
          isDark
      ...
      >
        <button
          onClick={() => setMobileTab(mobileTab === 'params' ? 'viewport' : 'params')}
          className={`flex flex-col items-center gap-1 text-[10px] font-mono font-bold py-1 px-4 rounded-xl transition-colors cursor-pointer ${
            mobileTab === 'params'
              ? isDark
        ...
        <button
          onClick={() => setMobileTab(mobileTab === 'specs' ? 'viewport' : 'specs')}
          className={`flex flex-col items-center gap-1 text-[10px] font-mono font-bold py-1 px-4 rounded-xl transition-colors cursor-pointer ${
            mobileTab === 'specs'
              ? isDark
                ? 'text-white bg-zinc-900'
