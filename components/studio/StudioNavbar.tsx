...
export const StudioNavbar: React.FC = () => {
  ...
  return (
    <header
      className={`h-14 sm:h-16 px-3 sm:px-6 flex items-center justify-between select-none z-40 transition-colors backdrop-blur-xl ${isDark ? 'bg-black/85 text-white' : 'bg-white/85 text-black'
        }`}
    >
      {/* Hidden File Input */}
      <input
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-2.5 sm:px-3.5 py-1.5 sm:py-2 rounded-lg text-[11px] sm:text-xs font-mono font-bold uppercase tracking-wider cursor-pointer transition-all active:scale-95 ${isDark
            ? ' text-white'
            : ' text-black '
            }`}
        >
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        ...
        >
          ...
          <button
            ...
            className={`p-1 sm:px-2.5 sm:py-1 text-xs font-mono uppercase tracking-wider rounded-md sm:rounded-lg font-medium transition-all ${viewMode === 'wireframe'
              ? isDark
          ...
          <button
            ...
            className={`p-1 sm:px-2.5 sm:py-1 text-xs font-mono uppercase tracking-wider rounded-md sm:rounded-lg font-medium transition-all ${showBoundingBox
              ? isDark
                ? 'bg-white text-black font-bold'
                : 'bg-black text-white font-bold'
              : isDark
          ...
          <button
            ...
            className={`p-1 sm:p-1.5 text-xs rounded-md sm:rounded-lg transition-all ${isDark ? 'text-zinc-400 hover:text-white' : 'text-zinc-600 hover:text-black'
              }`}
